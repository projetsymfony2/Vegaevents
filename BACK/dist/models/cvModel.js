...
export const uploadCVToDatabase = async (file) => {
...
export const getAllCVsFromDatabase = async () => {
    ...
    return { files: data }; // Retourner les fichiers si tout se passe bien
};
// Fonction pour supprimer un fichier CV depuis Supabase Storage
export const deleteCVFromDatabase = async (fileName) => {
...
export const saveCandidature = async (fullName, phoneNumber, fileUrl) => {
    const { data, error } = await supabase
