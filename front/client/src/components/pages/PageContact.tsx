...
const PageContact: React.FC = () => {
  return (
    <div className="mt-32  max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 mt-4 leading-relaxed">
            Vous avez un projet ou une idée à développer ? Contactez-nous, nous serions ravis de vous aider.
          </p>
          ...
          <ul className="mt-12 space-y-8">
            <li className="flex items-center">
              ...
              <a href="mailto:contact@vegaevents.com" className="text-white text-sm ml-4">
                contact@vegaevents.com
              </a>
            </li>
            <li className="flex items-center">
              <svg
              ...
              <a href="tel:+336789898989" className="text-white text-sm ml-4">
                +33 6 78 89 89 89
              </a>
            </li>
            <li className="flex items-center">
              ...
              <a className="text-white text-sm ml-4">
                13 rue rosa parks, Paris 75000
              </a>
            </li>
          </ul>
